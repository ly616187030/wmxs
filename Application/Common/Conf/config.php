...
$_config = array(
    ...
    'COMPANY_NAME'    => '包头市助友科技有限公司',   // 公司名称
    'DEVELOP_TEAM'    => '包头市助友科技有限公司',   // 当前项目开发团队名称［未授权版仅允许修改此项］

    // 产品简介
    'PRODUCT_INFO'    => '包头市助友科技有限公司',

    // 公司简介
    'COMPANY_INFO'    => '包头市助友科技有限公司',
    ...
    'MODULE_ALLOW_LIST'  => array('Home','Admin','Install','Dispatch'),
    ...
    'TMPL_PARSE_STRING'  => array(
        ...
        '__HOME_IMAGES__'=> __ROOT__.'/'.APP_PATH.'Home/View/Public/images',
        ...
        '__STATIC__'  => __ROOT__.'/'.APP_PATH.'Home/View/Public/static',
        '__DISPATCH__'=>__ROOT__.'/'.APP_PATH.'Dispatch/View/Public',
        '__WEIXIN__'=>__ROOT__.'/'.APP_PATH.'Weixin/View/Public'
    ),
