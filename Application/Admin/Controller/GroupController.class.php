...
class GroupController extends AdminController {
    ...
    public function index() {
        ...
        // 获取所有部门
        if(!is_administrator()){
            $map['founder_id'] = session('user_auth.founder_id');
    ...
    public function add2(){
        $menu = D('Admin/AuthRule')->getAuthRule();
        $tree = new Tree();
        $res = $tree->list_to_tree($menu,'id','parentid');
        //dump($res);
        $this->assign('all_module_menu_list', $res);
